<!-- .page-content start -->
<div  style="background-image: url(./img/plate/plain.jpg);" class="page-content custom-img-background dark page-title page-title-4 mb-100">
    <div class="container">
        <!-- .row start -->
        <div class="row">
            <!-- .col-md-12 start -->
            <div class="col-md-12 centered">
                <div class="custom-heading style-1 triggerAnimation animated" data-animate='fadeInUp'>
                    <br/> <h1><span>  GASTRONOMIE </span></h1>
        ...
        <div class="row gallery-filters">
            <div class="col-md-12 mb-20 centered triggerAnimation animated" data-animate='fadeIn'>
                ...
                <!-- <ul id="filters">
                     ...
                     <li><a href="#" data-filter=".indoor">PATISSERIE MAROCAINE</a></li>
                     <li><a href="#" data-filter=".outdoor">AUTRE</a></li>
                 </ul> -->
            </div><!-- .col-md-12 end -->
    ...
    <div class="container-fluid">
        <div class="row">
            <ul id="galleryitems" class="isotope isotopeitems-full">
                <?php foreach($gastronomies as $gastronomie): ?>
                    <li class="col-xs-6 col-md-3 isotope-item indoor">
                        <figure class="gallery-item-container">
                            <div class="gallery-img">
                                <img src="<?= 'img/gastronomie/'.$gastronomie->image ;?>" alt="" style="width: 380px;height: 208px;"/>

                                <div class="hover-mask-container">
                                    <div class="hover-zoom">
                                        <a href="<?= 'img/gastronomie/'.$gastronomie->image ;?>" class="triggerZoom fa fa-search"></a>
                                    </div><!-- .hover-zoom end -->
                ...
                <form class="wpcf7 contact-form-extended" method="post">
                    <fieldset>
                        ...
                        <span class="wpcf7-form-control-wrap your-email">
                                    ...
                                    <input name="type" value="gastronomie" class="otw-reservation-email" type="hidden" >
                                </span>
